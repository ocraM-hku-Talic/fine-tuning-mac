...
input_file = "../data/raw/course_qa_data.jsonl"
output_file = "../data/raw/cleaned_course_qa_data.jsonl"
...
print(f"  - Training: ../data/processed/Train.jsonl ({len(train_data)} examples)")
print(f"  - Validation: ../data/processed/Valid.jsonl ({len(valid_data)} examples)")
print(f"  - Test: ../data/processed/Test.jsonl ({len(test_data)} examples)")
